<?php
$data_pegawai = query("SELECT * FROM pegawai LEFT JOIN bagian ON pegawai.id_bagian = bagian.id_bagian WHERE nip='$nip'");
?>
<table class="text-dark mt-3">
    ...
    <tr>
        <td>ID - Nama Bagian</td>
        <td>:</td>
        <td><?= strtoupper($data_pegawai[0]['id_bagian']) ?> - <?= strtoupper($data_pegawai[0]['nama_bagian']) ?> </td>
    </tr>
    <tr>
        <td>Alamat</td>
        <td>:</td>
